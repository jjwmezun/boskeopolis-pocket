...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _block_system__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./block-system */ \"./src/block-system.js\");\n/* harmony import */ var _block_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block-types */ \"./src/block-types.js\");\n\n\n\nclass Map\n{\n\tconstructor( renderer )\n\t{\n\t\tthis.width = 50;\n\t\tthis.height = 20;\n\t\tthis.blocks =\n\t\t[\n\t\t\t{\n\t\t\t\ttype: \"ground\",\n\t\t\t\tx: 0,\n\t\t\t\ty: 17,\n\t\t\t\tw: 25,\n\t\t\t\th: 3\n\t\t\t},\n\t\t\t{\n\t\t\t\ttype: \"brick1\",\n\t\t\t\tx: 1,\n\t\t\t\ty: 12,\n\t\t\t\tw: 7,\n\t\t\t\th: 5\n\t\t\t},\n\t\t\t{\n\t\t\t\ttype: \"hydrant\",\n\t\t\t\tx: 9,\n\t\t\t\ty: 16\n\t\t\t},\n\t\t\t{\n\t\t\t\ttype: \"brick1\",\n\t\t\t\tx: 11,\n\t\t\t\ty: 14,\n\t\t\t\tw: 9,\n\t\t\t\th: 3\n\t\t\t},\n\t\t\t{\n\t\t\t\ttype: \"brick1\",\n\t\t\t\tx: 23,\n\t\t\t\ty: 11,\n\t\t\t\tw: 5,\n\t\t\t\th: 6\n\t\t\t}\n\t\t];\n\n\t\tthis.blockSystem = new _block_system__WEBPACK_IMPORTED_MODULE_0__[\"default\"]( this, renderer );\n\t}\n\n\ttestInteraction( autumn, nextPosition )\n\t{\n\t\tfor ( const block of this.blocks )\n\t\t{\n\t\t\tconst blockType = _block_types__WEBPACK_IMPORTED_MODULE_1__[\"default\"][ block.type ];\n\t\t\tif ( 'interaction' in blockType )\n\t\t\t{\n\t\t\t\tnextPosition = blockType.interaction( block, autumn, nextPosition );\n\t\t\t}\n\t\t}\n\t\treturn nextPosition;\n\t}\n\n\ttestOnGround( autumn )\n\t{\n\t\tif ( this.blockSystem.yInSolid( autumn.y + autumn.height, autumn.x, autumn.width ) )\n\t\t{\n\t\t\treturn true;\n\t\t}\n\t\tfor ( const block of this.blocks )\n\t\t{\n\t\t\tconst blockType = _block_types__WEBPACK_IMPORTED_MODULE_1__[\"default\"][ block.type ];\n\t\t\tif ( 'testOnGround' in blockType )\n\t\t\t{\n\t\t\t\tif ( blockType.testOnGround( block, autumn ) )\n\t\t\t\t{\n\t\t\t\t\treturn true;\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t\treturn false;\n\t}\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (Map);\n\n\n//# sourceURL=webpack:///./src/map.js?");
